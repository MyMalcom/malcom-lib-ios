...
@class MCMASIDataDecompressor;

extern NSString *MCMASIHTTPRequestVersion;
...
extern NSString* const MCMNetworkRequestErrorDomain;
...
extern unsigned long const MCMASIWWANBandwidthThrottleAmount;
...
@interface MCMASIHTTPRequest : NSOperation <NSCopying> {
	...
	// The delegate - will be notified of various changes in state via the MCMASIHTTPRequestDelegate protocol
	id <MCMASIHTTPRequestDelegate> delegate;
	...
	id <MCMASIHTTPRequestDelegate, MCMASIProgressDelegate> queue;
	...
	id <MCMASIProgressDelegate> uploadProgressDelegate;
	...
	id <MCMASIProgressDelegate> downloadProgressDelegate;
	...
	MCMASIDataDecompressor *dataDecompressor;
	...
	MCMASIHTTPRequest *PACFileRequest;
...
@property (assign) MCMASIHTTPRequest *mainRequest;
...
@property (assign) id <MCMASICacheDelegate> downloadCache;
@property (assign) MCMASICachePolicy cachePolicy;
@property (assign) MCMASICacheStoragePolicy cacheStoragePolicy;
...
#endif
@property (retain) MCMASIDataDecompressor *dataDecompressor;
