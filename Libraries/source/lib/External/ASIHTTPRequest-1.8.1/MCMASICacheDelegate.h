...
typedef enum MCM_ASICachePolicy {
...
} MCMASICacheStoragePolicy;


@protocol MCMASICacheDelegate <NSObject>
...
- (void)clearCachedResponsesForStoragePolicy:(MCMASICacheStoragePolicy)cachePolicy;
