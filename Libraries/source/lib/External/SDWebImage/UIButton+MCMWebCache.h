/*
 * This file is part of the MCMSDWebImage package.
...
/**
 * Integrates MCMSDWebImage async downloading and caching of remote images with UIButtonView.
 */
@interface UIButton (WebCache) <MCMSDWebImageManagerDelegate>
 ...
 * @param url The url for the image.
 * @param placeholder The image to be set initially, until the image request finishes.
 * @param options The options to use when downloading the image. @see MCMSDWebImageOptions for the possible values.
 */
